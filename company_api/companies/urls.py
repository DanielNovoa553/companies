...
from .views import CompanyListCreate, CompanyDetail, companies_list_view, get_companies, update_company, add_company, delete_company, get_company_details
from . import views
...
urlpatterns = [
    ...
    path('get_companies/', get_companies, name='get-companies'), # Obtener todas las compañías (API)
